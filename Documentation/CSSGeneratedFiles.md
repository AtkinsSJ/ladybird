...
| `longhands`                       | No       | `[]`    | Array of strings. If this is a shorthand, these are the property names that it expands out into.            | `Vector<PropertyID> direct_longhands_for_shorthand(PropertyID)`<br/>`Vector<PropertyID> expanded_longhands_for_shorthand(PropertyID)`<br/>`Vector<PropertyID> shorthands_for_property(PropertyID)` |

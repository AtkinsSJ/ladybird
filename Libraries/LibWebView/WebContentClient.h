...
private:
    ...
    virtual void did_query_selector(u64 page_id, u64 request_id, Optional<Web::UniqueNodeID> node_id, Optional<String> error) override;
    virtual void did_query_selector_all(u64 page_id, u64 request_id, Vector<Web::UniqueNodeID> node_ids, Optional<String> error) override;

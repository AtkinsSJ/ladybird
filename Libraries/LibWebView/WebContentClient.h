...
private:
    ...
    virtual void did_get_debugger_environments(u64 page_id, u64 request_id, Vector<DebuggerEnvironment>) override;
    ...
    virtual void did_cancel_geolocation_position_request(u64 page_id, u64 request_id) override;

...
private:
    ...
    virtual void query_selector(DevTools::TabDescription const&, Web::UniqueNodeID, String const&, OnDOMNodeQuerySelectorComplete) const override;
    virtual void query_selector_all(DevTools::TabDescription const&, Web::UniqueNodeID, String const&, OnDOMNodeQuerySelectorAllComplete) const override;

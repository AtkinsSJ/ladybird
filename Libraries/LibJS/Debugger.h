...
public:
    ...
    bool should_pause_on_exception(Bytecode::Executable&, u32 bytecode_offset, Value exception, bool exception_will_be_caught);
...
private:
    ...
    Optional<u64> m_last_paused_exception;

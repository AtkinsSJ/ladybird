...
{
    add_owned_actor(css_properties);
    add_owned_actor(console);
    add_owned_actor(inspector);
    add_owned_actor(style_sheets);
    add_owned_actor(thread);
    add_owned_actor(accessibility);

...
Optional<CSS::QueryValue> Window::query_media_feature(CSS::MediaFeatureID media_feature) const
{
    ...
    case CSS::MediaFeatureID::AnyHover:
        return CSS::KeywordStyleValue::create(CSS::Keyword::Hover);
    case CSS::MediaFeatureID::AnyPointer:
        return CSS::KeywordStyleValue::create(CSS::Keyword::Fine);
    case CSS::MediaFeatureID::AspectRatio:
        return CSS::RatioStyleValue::create(CSS::NumberStyleValue::create(inner_width()), CSS::NumberStyleValue::create(inner_height()));
    case CSS::MediaFeatureID::Color:
        return CSS::IntegerStyleValue::create(8);
    case CSS::MediaFeatureID::ColorGamut:
        return CSS::KeywordStyleValue::create(CSS::Keyword::Srgb);
    case CSS::MediaFeatureID::ColorIndex:
        return CSS::IntegerStyleValue::create(0);
    case CSS::MediaFeatureID::DeviceAspectRatio: {
        auto screen_area = page().client().screen_rect();
        return CSS::RatioStyleValue::create(CSS::NumberStyleValue::create(screen_area.width().value()), CSS::NumberStyleValue::create(screen_area.height().value()));
    }
    case CSS::MediaFeatureID::DeviceHeight:
        return CSS::LengthStyleValue::create(CSS::Length::make_px(page().web_exposed_screen_area().height()));
    case CSS::MediaFeatureID::DeviceWidth:
        return CSS::LengthStyleValue::create(CSS::Length::make_px(page().web_exposed_screen_area().width()));
    case CSS::MediaFeatureID::DisplayMode:
        // FIXME: Detect if window is fullscreen
        return CSS::KeywordStyleValue::create(CSS::Keyword::Browser);
    case CSS::MediaFeatureID::DynamicRange:
        return CSS::KeywordStyleValue::create(CSS::Keyword::Standard);
    case CSS::MediaFeatureID::EnvironmentBlending:
        return CSS::KeywordStyleValue::create(CSS::Keyword::Opaque);
    case CSS::MediaFeatureID::ForcedColors:
        return CSS::KeywordStyleValue::create(CSS::Keyword::None);
    ...
    case CSS::MediaFeatureID::HorizontalViewportSegments:
        return CSS::IntegerStyleValue::create(1);
    ...
    case CSS::MediaFeatureID::NavControls:
        return CSS::KeywordStyleValue::create(CSS::Keyword::Back);
    case CSS::MediaFeatureID::Orientation:
        return CSS::KeywordStyleValue::create(inner_height() >= inner_width() ? CSS::Keyword::Portrait : CSS::Keyword::Landscape);
    case CSS::MediaFeatureID::OverflowBlock:
        return CSS::KeywordStyleValue::create(CSS::Keyword::Scroll);
    ...
    case CSS::MediaFeatureID::PrefersColorScheme: {
        ...
        case CSS::PreferredColorScheme::Light:
            return CSS::KeywordStyleValue::create(CSS::Keyword::Light);
        case CSS::PreferredColorScheme::Dark:
            return CSS::KeywordStyleValue::create(CSS::Keyword::Dark);
        default:
            VERIFY_NOT_REACHED();
        }
    }
    case CSS::MediaFeatureID::PrefersContrast:
        ...
        case CSS::PreferredContrast::Less:
            return CSS::KeywordStyleValue::create(CSS::Keyword::Less);
        case CSS::PreferredContrast::More:
            return CSS::KeywordStyleValue::create(CSS::Keyword::More);
        case CSS::PreferredContrast::NoPreference:
            return CSS::KeywordStyleValue::create(CSS::Keyword::NoPreference);
    ...
    case CSS::MediaFeatureID::PrefersReducedMotion:
        ...
        case CSS::PreferredMotion::Reduce:
            return CSS::KeywordStyleValue::create(CSS::Keyword::Reduce);
    ...
    case CSS::MediaFeatureID::Resolution:
        return CSS::ResolutionStyleValue::create(CSS::Resolution::make_dots_per_pixel(device_pixel_ratio()));
    ...
    case CSS::MediaFeatureID::Scripting:
        if (associated_document().is_scripting_enabled())
            return CSS::KeywordStyleValue::create(CSS::Keyword::Enabled);
        return CSS::KeywordStyleValue::create(CSS::Keyword::None);
    case CSS::MediaFeatureID::Update:
        return CSS::KeywordStyleValue::create(CSS::Keyword::Fast);

...
NonnullRefPtr<CSSStyleValue const> Parser::resolve_unresolved_style_value(ParsingParams const& context, DOM::Element& element, Optional<PseudoElement> pseudo_element, PropertyID property_id, UnresolvedStyleValue const& unresolved)
{
    ...
    return parser.resolve_unresolved_style_value(abstract_element, property_id, unresolved);
}
...
NonnullRefPtr<CSSStyleValue const> Parser::resolve_unresolved_style_value(DOM::AbstractElement& element, PropertyID property_id, UnresolvedStyleValue const& unresolved)
{
    // To replace substitution functions in a property prop:
    // FIXME: Support this for custom properties.
    ...
    auto result = substitute_arbitrary_substitution_functions(element, guarded_contexts, unresolved.values(), SubstitutionContext { SubstitutionContext::DependencyType::Property, string_from_property_id(property_id).to_string() });

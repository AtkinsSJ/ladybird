...
public:
    ...
    [[nodiscard]] GC::Root<GC::HeapVector<GC::Ref<Key>>> value_as_vector() { return m_value.get<GC::Root<GC::HeapVector<GC::Ref<Key>>>>(); }
    [[nodiscard]] GC::Root<GC::HeapVector<GC::Ref<Key>>> subkeys()
    {
        VERIFY(m_type == Array);

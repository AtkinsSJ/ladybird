...
{
    static constexpr auto overlay_color = Color(0xdd, 0xe1, 0xe4, 168);
    static constexpr auto toolbar_color = Color(0xfc, 0xfc, 0xfc);
    static constexpr auto toolbar_border_color = Color(0xdd, 0xe1, 0xe4);
    static constexpr auto button_hover_color = Color(0xe7, 0xe7, 0xe7);
    static constexpr auto text_color = Color(0x58, 0x59, 0x59);
    static constexpr auto shadow_color = Color(0x9b, 0x9b, 0x9b, 66);
